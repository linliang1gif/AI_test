...
REGRESSION_SCRIPTS = [
    ("P0-7 Smoke 冒烟测试",           "tests/regression/smoke_p0_7_local.py",            True,  False, None,           {"smoke","core","full"}),
    ("API Contract 契约检查",          "tests/regression/check_api_contract.py",          True,  False, None,           {"smoke","core","full"}),
    ("P1-7A Import Pipeline",          "tests/regression/test_p1_7a_import_pipeline.py",  True,  False, None,           {"core","full"}),
    ("P1-7D Real Mode Safety",         "tests/regression/test_p1_7d_real_mode_safety.py", True,  False, None,           {"core","full"}),
    ("P1-7E Report Persistence",       "tests/regression/test_p1_7e_report_persistence.py", True,  False, None,         {"core","full"}),
    ("Phase 18 执行稳定性",            "tests/regression/test_phase18.py",                False, False, "external_api", {"full"}),
    ("P2-3 Web UI Case Model",          "tests/regression/test_p2_3_web_ui_case_model.py", True,  False, None,          {"core","full"}),
    ("P2-4 Playwright Engine MVP",     "tests/regression/test_p2_4_playwright_engine_mvp.py", True, False, "browser",   {"core","full"}),
    ("P2-5 Visual Regression MVP",     "tests/regression/test_p2_5_visual_regression_mvp.py", True, False, "browser",   {"core","full"}),
    ("P2-6 Playwright Enhanced",       "tests/regression/test_p2_6_playwright_enhanced.py",  True, False, "browser",    {"core","full"}),
    ("P2-6B API Performance MVP",      "tests/regression/test_p2_6b_api_performance_mvp.py", True, False, None,         {"core","full"}),
    ("P2-7 Web UI Batch/Trace",        "tests/regression/test_p2_7_web_ui_batch_trace.py",   True, False, "browser",   {"core","full"}),
    ("P2-8 AI UI Failure Analysis",   "tests/regression/test_p2_8_ai_ui_failure_analysis.py", True, False, "browser",   {"core","full"}),
    ("P2-9B Web UI Stability",        "tests/regression/test_p2_9b_web_ui_stability.py",  True, False, "browser",     {"core","full"}),
    ("P2-10 Test Suite Management",    "tests/regression/test_p2_10_test_suite_management.py", True, False, None,       {"core","full"}),
    ("P3-1 CI Quality Gate",           "tests/regression/test_p3_1_ci_quality_gate.py",  True, False, None,            {"core","full"}),
    ("P3-2 Test Data Management",      "tests/regression/test_p3_2_test_data_management.py", True, False, None,        {"core","full"}),
    ("P3-3A Test Data Enhancement",    "tests/regression/test_p3_3a_test_data_enhancement.py", True, False, None,      {"core","full"}),
    ("P3-3B Defect Management",        "tests/regression/test_p3_3b_defect_management.py", True, False, None,          {"core","full"}),
    ("P3-4A Quality Dashboard",        "tests/regression/test_p3_4a_quality_dashboard.py", True, False, None,          {"core","full"}),
    ("P3-4B Quality Trends Risk",      "tests/regression/test_p3_4b_quality_trends_risk.py", True, False, None,        {"core","full"}),
    ("P3-5 Test Selection",            "tests/regression/test_p3_5_test_selection_recommendation.py", True, False, None,{"core","full"}),
    ("P1-8A AI Heal Guard",            "tests/regression/test_p1_8a_ai_heal_guard.py",   False, True,  None,           {"full"}),
    ("P1-8 AI Case Review",            "tests/regression/test_p1_8_ai_case_review.py",   False, True,  None,           {"full"}),
]
