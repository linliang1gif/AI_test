...
export const visualAPI = api.v2.visual

// Phase 10B: 危险操作 confirm_text 常量（与后端守卫严格一致）
export const VISUAL_DANGER = Object.freeze({
  DELETE_BASELINE: 'DELETE_BASELINE',
  BULK_DELETE_BASELINES: 'BULK_DELETE_BASELINES',
